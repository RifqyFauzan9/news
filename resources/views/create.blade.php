    ...
    <div class="min-h-full">
        ...
        <header class="bg-white shadow">
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 flex justify-center items-center gap-5">
                <h1 class="text-xl md:text-3xl font-bold tracking-tight text-gray-900 text-center">📰🔥CREATE NEWS!!🔥📰</h1>
            </div>
        </header>
        ...
        <main>
            <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
                <!-- Your content -->
                <form class="px-5" action="{{ route('post.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('post')
                    <div class="space-y-5">
                        ...
                        <div class="border-b border-gray-900/10 pb-12">
                            <div class="mt-3 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <div class="mt-2">
                                        <input type="text" name="description" id="last-name"
                                ...
                                <div class="col-span-full">
                                    ...
                                    <div class="mt-2">
                                        <input type="text" name="content" id="street-address"
